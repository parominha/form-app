...
const Produto = (props: Props) => {
    return (
        <div style={{alignContent: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column', border: '1px dashed #ddd', borderRadius: '15px', padding: 10}}>
            <img style={{ maxHeight: '200px', maxWidth: '200px' }} src='src\assets\images\product-image.png' alt='Foto do produto' />
